    ...
    return (
        <>
            ...
            <Card>
                ...
                <p>Hide or blur content from categories you find triggering.</p>
                 <div className="expertise-options" style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', marginTop: '1rem' }}>
             ...
             <Card>
                ...
                <div className="setting-item">
                    <div>
                        <label htmlFor="research-consent-toggle" style={{fontWeight: 'bold'}}>Contribute to Public Health Research</label>
                        <p style={{fontSize: '0.9rem', color: 'var(--text-secondary)', marginRight: '1rem'}}>Help researchers by contributing your fully anonymized data.</p>
                    </div>
                    <div className="theme-toggle">
                        <input 
                            type="checkbox" 
                 ...
                 <div style={{textAlign: 'right', marginTop: '0.5rem'}}>
                    <a href="#" onClick={(e) => { e.preventDefault(); setIsPrivacyModalOpen(true); }} style={{color: 'var(--accent-primary)', fontSize: '0.9rem'}}>Learn More</a>
                </div>
            </Card>
            ...
            <Card>
                ...
                <div className="setting-item">
                     <p>Permanently block communication with specific users.</p>
                     <AppButton variant="secondary" onClick={() => setActiveView('blocked-users')}>Manage Blocked Users</AppButton>
                </div>
                <hr style={{margin: '1rem 0', border: 'none', borderBottom: '1px solid var(--border-color)'}}/>
                 <div className="setting-item">
                    <p>Reset your anonymous ID for a fresh start.</p>
                     <AppButton variant="danger" onClick={() => setIsResetModalOpen(true)}>Reset Anonymous ID</AppButton>
                </div>
            </Card>
        </>
    );
