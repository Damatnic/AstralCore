...
import { SendIcon, AICompanionIcon } from '../components/icons';
...
export const ShareView: React.FC<{
    onPostSubmit: (dilemma: Omit<Dilemma, 'id' | 'userToken' | 'supportCount' | 'isSupported' | 'isReported' | 'reportReason' | 'status' | 'assignedHelperId'>) => void;
