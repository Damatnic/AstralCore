    ...
    <>
        ...
        <Card className="legal-card">
            <section>
                ...
                <p><strong><em>Disclaimer: The legal text provided here is a placeholder for demonstration purposes and is not a substitute for real legal advice. You must consult with a qualified lawyer to draft your official terms.</em></strong></p>
            </section>
