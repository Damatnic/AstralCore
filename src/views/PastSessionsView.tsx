...
import { KudosIcon, HeartIcon } from '../components/icons';
import { formatTimeAgo } from '../utils/formatTimeAgo';
import { useSessionStore } from '../stores/sessionStore';
import { EmptyState } from '../components/EmptyState';
import { MyPostsIcon } from '../components/icons';
    ...
    <>
        <Modal isOpen={isSummaryModalOpen} onClose={() => setIsSummaryModalOpen(false)} title="Chat Summary">
            <div className="markdown-content">
                <ReactMarkdown remarkPlugins={[remarkGfm]}>{selectedSessionSummary}</ReactMarkdown>
            </div>
        </Modal>
