...
import { Dilemma, Helper, ActiveView, Achievement, HelpSession } from '../types';
import { PostCard } from '../components/PostCard';
import { ThumbsUpIcon, PostsIcon, CertifiedIcon, KudosIcon, AchievementsIcon, HeartIcon } from '../components/icons';
...
export const HelperDashboardView: React.FC<{
    ...
    return (
        <>
            <Modal isOpen={isSummaryModalOpen} onClose={() => setIsSummaryModalOpen(false)} title="Your Private Performance Feedback"><div className="markdown-content"><ReactMarkdown remarkPlugins={[remarkGfm]}>{selectedSummary}</ReactMarkdown></div></Modal>
